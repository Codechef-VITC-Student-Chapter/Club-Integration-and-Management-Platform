...
const ProfileCard = ({ isAdmin = true, FirstName = "FirstName", LastName = "LastName", regNo, badges = [] }) => {
    return (
        <div className={`h-full w-full rounded-3xl flex flex-col p-4 gap-6 justify-center items-center text-white`}>
            <div className='w-full h-full flex-col gap-8 items-center text-center md:block hidden'>
             {isAdmin && <button className=' bg-[#4079DA] p-3 rounded-xl text-center text-md'
