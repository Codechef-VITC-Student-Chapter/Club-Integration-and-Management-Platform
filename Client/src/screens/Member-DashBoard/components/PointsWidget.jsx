        ...
        return (
          <div key={club} className="flex flex-col">
            <div className="bg-[#2E3446] rounded-tr-3xl rounded-tl-3xl flex justify-center items-center w-full h-9">
              <h1 className="text-white text-center text-sm md:text-base md:block hidden whitespace-nowrap">
                Club Points Breakdown
              </h1>
              <h1 className="text-white text-center text-sm md:text-base md:hidden block whitespace-nowrap">
                Points Breakdown
              </h1>
            </div>
            <div className="flex md:flex-row justify-center items-center pt-4">
              <div className="rounded-full h-28 w-28 md:h-36 md:w-36 relative flex justify-center items-center pb-0 transform scale-90 sm:scale-100">
                <div className="flex">
                  <svg
                    width="100%"
                    height="100%"
                ...
                <div className="rounded-full flex justify-center items-center absolute">
                  <h1 className="font-bold md:text-[15px] lg:text-[35px] text-black">
                    {totalPoints}
                  </h1>
                </div>
              </div>
              <div className="flex flex-col justify-center items-center mt-4 md:mt-0 pr-2 transform scale-90 sm:scale-100">
                <h1 className="text-[#4CAF50] font-bold text-sm md:text-lg md:block hidden whitespace-nowrap">
                  Total Points Earned
                </h1>
                <h1 className="text-[#4CAF50] font-bold text-sm md:text-lg md:hidden block whitespace-nowrap">
                  Earned
                </h1>
                <h1 className="text-[#4CAF50] text-sm md:text-center font-semibold">
                  {totalPoints}/100
                </h1>
                <h1 className="text-[#FFC107] font-bold text-sm md:text-lg md:block hidden whitespace-nowrap">
                  Pending Points
                </h1>
                <h1 className="text-[#FFC107] text-sm md:text-lg md:hidden block whitespace-nowrap">
                  Pending
                </h1>
                <h1 className="text-[#FFC107] text-sm font-semibold md:text-center">
