...
const MemberTable = () => {
  ...
  return (
    <div className="min-h-screen bg-[#EAF1FD] flex justify-center items-center px-4 py-6">
      <div className="w-full max-w-5xl">
        ...
        {/* Member List - FIXED */}
        <div
          className={`overflow-y-auto max-h-[500px] rounded-lg shadow-md pr-2 ${styles.scrollbarCustom}`}
        >
